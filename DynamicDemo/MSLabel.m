...
//            drawX = floorf((self.frame.size.width - [line sizeWithFont:self.font].width) / 2);
            drawX = floorf((self.frame.size.width - [Utility simpleSizeWithStr:line font:self.font].width) / 2);
        } else if (self.textAlignment == NSTextAlignmentRight) {
//            drawX = (self.frame.size.width - [line sizeWithFont:self.font].width);
            drawX = (self.frame.size.width - [Utility simpleSizeWithStr:line font:self.font].width);
        }
...
- (NSArray *)stringsFromText:(NSString *)string {
    ...
    while (characterArray.count != 0) {
        ...
        for (int i = 0; i < [characterArray count]; i++) {
            ...
            CGFloat stringWidth = [Utility simpleSizeWithStr:[line stringByAppendingFormat:@"%@", character] font:self.font].width;
